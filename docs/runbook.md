...
- Current version: v5b2 (strict cold‑start, SimHash, monthly + daily/weekly tags, LO/HI gating, sender_key normalization).
...
```
- Selection and remaining share the same predicate (v5b2 + missing metadata).
